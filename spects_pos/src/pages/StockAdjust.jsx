...
import { Form, Input, Button, Select, Table, notification, DatePicker } from 'antd';
...
const StockAdjust = () => {
  ...
  return (
    <div className="container bg-white p-4">
      <h3 className="text-md">Stock <span className="text-yellow-500">Adjustment</span></h3>

      <Form form={form} onFinish={handleFormSubmit} layout="vertical" className="grid grid-cols-12 gap-2">
        <div className="col-span-12 border-2 border-gray-200 p-2">
          <div className="grid grid-cols-12 gap-4">
            ...
            <Form.Item name="itemName" label="Item Name" className="col-span-3">
              <Input value={itemResult?.description || ''} readOnly />
            </Form.Item>

            <Form.Item name="available" label="Available" className="col-span-3">
              <Input value={itemResult?.maxStockQty || ''} readOnly />
            </Form.Item>
          </div>

          <div className="grid grid-cols-12 gap-4">
            <Form.Item name="noteNo" label="Adjustment Note No" className="col-span-3">
            ...
            <Form.Item name="newStock" label="New Stock" className="col-span-3">
              <Input readOnly />
            </Form.Item>
          </div>
        ...
        <div className="col-span-12 text-right">
          ...
          <Button type="default" onClick={() => window.location.href = '/index'}>
            Exit
          </Button>
        </div>
      </Form>
